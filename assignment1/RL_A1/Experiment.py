...
def experiment():
    ...
    optimal_average_reward_per_timestep = 1.0352764975423694  # set the optimal average reward per timestep you found in the DP assignment here
    ...
    for backup in backups:
        for learning_rate in learning_rates:
            learning_curve = average_over_repetitions(backup, n_repetitions, n_timesteps, max_episode_length,
                                                      learning_rate,
                                                      gamma, policy, epsilon, temp, smoothing_window, plot, n)
